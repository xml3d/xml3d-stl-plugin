...
$(function() {
    ...
    var renderStatText = renderStream.map(function(e) { return "Tris:" + e.count.primitives;}).toProperty("?");

    var objectStream = Kefir.fromEvent(xml3d, 'mouseover', function(e) {
        if (e.target.nodeName == "MESH") {
...
},{"./sunburst":2,"domready":4,"kefir":5}],2:[function(require,module,exports){
var d3 = require('d3')
...
},{"d3":3,"prettysize":6}],3:[function(require,module,exports){
!function() {
  var d3 = {
    version: "3.5.5"
  };
